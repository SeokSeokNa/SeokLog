...
class PostServiceTest {
    ...
    void test3() {
        ...
        assertEquals("seok 제목 19",posts.get(0).getTitle());
        assertEquals("seok 제목 15",posts.get(4).getTitle());
    }
    ...
    void test4() {
        ...
        assertEquals("seok2" , changePost.getTitle());
        assertEquals("봉천동" , changePost.getContent());
